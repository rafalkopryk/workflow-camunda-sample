...
{
    private const string ActivitySourceName = "Camunda.Connector.Kafka.Inbound.Kafka";
    public static ActivitySource ActivitySource { get; } = new ActivitySource(ActivitySourceName);

    public static readonly Meter Meter = new("Camunda.Connector.Kafka.Inbound.Kafka");

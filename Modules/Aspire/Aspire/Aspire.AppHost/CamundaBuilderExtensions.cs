...
public static class CamundaBuilderExtensions
{
    ...
    {
        return builder
            .WithEnvironment("Camunda__Endpoint", source.Resource.ConnectionStringExpression)
            .WithEnvironment("Camunda__GrpcEndpoint", source.Resource.GrpcConnectionStringExpression)
